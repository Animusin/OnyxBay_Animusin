...
/mob/living/carbon/human/handle_environment(datum/gas_mixture/environment)
	...
	if(relative_density > 0.02) //don't bother if we are in vacuum or near-vacuum
		...
		if(adjusted_pressure < species.warning_high_pressure && adjusted_pressure > species.warning_low_pressure && abs(loc_temp - bodytemperature) < 0.5 && bodytemperature < species.heat_level_1 && bodytemperature > species.cold_level_1 && species.body_temperature)
			pressure_alert = 0
